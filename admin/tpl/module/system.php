...
elseif($method=='config')
{
	...
	$arr=array(
        ...
        array('p'=>'app','a'=>'filtertags','c'=>$MAC['app']['filtertags'],'t'=>0,'n'=>array('关闭','开启'),'v'=>array(2,1)),
...
elseif($method=='configapisave')
{
	...
	if(!empty($auth_art)){
		$auth_art = str_replace(chr(13),'#',str_replace(chr(10),'',$auth_art));
	}
	...
	$config['api']['art']['status'] = intval(trim(be('post','art_status')));
	$config['api']['art']['cjflag'] = trim(be('post','art_cjflag'));
...
elseif($method=='configapi')
{
	...
	$arr=array(
		...
		array('p'=>'art','a'=>'status','c'=>$MAC['api']['art']['status'],'t'=>0,'n'=>array('关闭','开启'),'v'=>array(0,1)),
		array('p'=>'art','a'=>'charge','c'=>$MAC['api']['art']['charge'],'t'=>0,'n'=>array('免费','收费'),'v'=>array(0,1)),
	);
	foreach($arr as $a){
